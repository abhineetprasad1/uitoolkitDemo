...
public class PooledObject
{
	...
	public PooledObject(string key, string prefabPath, bool extendWhenExhaust, int poolSize, Transform parent)
	{
		this.key = key;
		this.prefabPath = prefabPath;
		this.extendWhenExhaust = extendWhenExhaust;
		this.poolSize = poolSize;
		this.parent = parent;
		Init();
	}

	public PooledObject(string key, string prefabPath, bool extendWhenExhaust, Transform parent)
	{
		this.key = key;
		this.prefabPath = prefabPath;
		this.extendWhenExhaust = extendWhenExhaust;
	...
	private PooledObject Init()
	{
		...
		{
			Debug.LogError("Prefab file can not found: " + prefabPath);
		}
